# Controller to Control Products
class CartProductsController < ApplicationController
  before_action :getProduct, only: [:new]
  before_action :getCart, only: %i[new destroy add_quantity remove_quantity]
  before_action :getCartProduct, only: %i[destroy add_quantity remove_quantity]
